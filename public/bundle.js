...
const { fotos: fotos$2 } = dataFotos;

var dataCategorias = {
	categorias: [
		{ id: 'america', nombre: 'América', numeroFotos: fotos$2['america'].length, imagenPortada: './img/america.jpg' },
		{ id: 'europa', nombre: 'Europa', numeroFotos: fotos$2['europa'].length, imagenPortada: './img/europa.jpg' },
		{ id: 'africa', nombre: 'África', numeroFotos: fotos$2['africa'].length, imagenPortada: './img/africa.jpg' },
		{ id: 'asia', nombre: 'Asia', numeroFotos: fotos$2['asia'].length, imagenPortada: './img/asia.jpg' },
		{ id: 'oceania', nombre: 'Oceania', numeroFotos: fotos$2['oceania'].length, imagenPortada: './img/oceania.jpg' },
		{
			id: 'antartida',
			nombre: 'Antártida',
			numeroFotos: fotos$2['antartida'].length,
...
contenedorCategorias.addEventListener('click',(e)=>{
    ...
    if(e.target.closest('a')){
      ...
      const {id,nombre,descripcion,ruta}=fotos$1[categoriaActual][0];
      ...
      cargarFotos(id, nombre,descripcion,ruta);
       ...
       fotos$1[categoriaActual].forEach((foto)=> {
